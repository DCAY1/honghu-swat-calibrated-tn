...
- 原始观测与 SWAT 日输出见 `data/`；建模用日尺度特征表见 `outputs/processed/`。
- 正文图 1–3 以 `outputs/figures/` 中预渲染图提供；图 4–7 与表 2 可由 `scripts/` 下脚本从上述数据重生成。
- 气象数据请引用 He et al. (2020) CMFD；SWAT 空间基础数据请引用正文所列 SRTM、HWSD、CNLUCC 文献。
