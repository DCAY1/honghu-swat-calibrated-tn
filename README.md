...
- `data/` — meteorology, water quality, SWAT outputs, and hydrology inputs
- `outputs/` — processed modeling tables and paper artifacts
- `scripts/` — analysis code
- `honghu_nps/` — data loading utilities
